...
public class Strafe extends Command {
     ...
     * @param magnitudeside the speed of sidways movement
     * @param magnitudestraight the speed of forward movement
     * @param magnitudediagonal the speed of diagonal movement
     */
